...
<body style="background-image: url(assets/img/RegisterSideLeft.jpg);min-height: 686px;max-height: 125px;height: 708px;">
    ...
    <div class="row register-form" style="margin: 0px;margin-top: 19px;margin-left: 10px;min-height: 0px;max-height: 0px;">
        <div class="col-md-8 offset-md-2" style="margin-left: 302px;padding-right: 0px;padding-left: 15px;margin-top: 69px;height: 868px;min-height: 868px;max-height: 868px;">
            <form action="RegistrationServlet" name="myform"  method="POST" class="custom-form" style="width: 1188px;height: 778px;">
                ...
                <div class="form-row" style="margin-left:-50px;">
                    <div class="col" style="width: 400px;min-width: 123.703px;max-width: 400px;min-height: 42;max-height: 42;height: 42px;"><label class="col-form-label d-xl-flex justify-content-xl-end" style="color: rgb(95,95,95);margin-right:270px;">User Street</label></div>
                    <div class="col" style="height: 42px;width: 766px;min-width: 532;max-width: 540px;"><input class="form-control" type="text" name="userStreet" id="userStreet" placeholder="ex. Via Francesco Calò 85, Roma" style="margin-left:40px;width:580px;"></div>
                </div>
                <div class="form-check" style="width: 1077px;height: 17px;margin-left: -171px;margin-top: -7px;"><input class="form-check-input" type="checkbox" name="managerProperty"  id="managerProperty" value="off" style="width: 22px;height: 32px;margin-left: -190px;margin-top: 10px;"><label class="form-check-label" for="formCheck-1" style="font-size: 14px;color: rgb(95,95,95);margin-top: 19px;margin-left: -590px;">Are you a gym manager?</label></div>
                <div
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" id="gymName" name="gymName" type="text" placeholder="Gym name" style="margin-left:3px;"></div>
        </div>
        <div class="form-row form-group" style="margin-top: 33px;">
            ...
            <div class="col-sm-6 input-column"><input class="form-control" type="text" id="gymStreet" name="gymStreet" placeholder="ex. Via Francesco Calò 82, Roma" style="margin-left:3px;"></div>
